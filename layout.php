...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        /* SIDEBAR */
        #sidebar { width: 230px; background: #161820; border-right: 1px solid #2a2d3a; display: flex; flex-direction: column; position: fixed; top: 0; left: 0; height: 100vh; z-index: 100; transition: width .25s; overflow: hidden; }
        .sidebar-logo { padding: 16px; border-bottom: 1px solid #2a2d3a; display: flex; align-items: center; gap: 10px; white-space: nowrap; }
        .logo-icon { width: 34px; height: 34px; background: #2563eb; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
        ...
        .nav-badge { margin-left: auto; background: #431407; color: #fb923c; font-size: 10px; padding: 1px 6px; border-radius: 10px; }
        ...
        /* TOPBAR */
        #topbar { position: fixed; top: 0; left: 230px; right: 0; height: 54px; background: #161820; border-bottom: 1px solid #2a2d3a; display: flex; align-items: center; padding: 0 20px; gap: 12px; z-index: 99; transition: left .25s; }
        ...
        /* MAIN CONTENT */
        #main { margin-left: 230px; margin-top: 54px; padding: 24px; min-height: calc(100vh - 54px); transition: margin-left .25s; width: calc(100% - 230px); }
...
<div id="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>index.php"
           class="nav-item <?php echo $current_page=='index.php' && $current_dir!='www' ? 'active' : ($current_page=='index.php' ? 'active' : ''); ?>">
            <i class="bi bi-speedometer2"></i> Tableau de bord
        </a>

        <div class="nav-section-title">Patients</div>
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>patient/patient_list.php"
           class="nav-item <?php echo $current_dir=='patient' ? 'active' : ''; ?>">
            <i class="bi bi-people"></i> Patients
        </a>
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>rendezvous/rendezvous_list.php"
           class="nav-item <?php echo $current_dir=='rendezvous' ? 'active' : ''; ?>">
            <i class="bi bi-calendar-check"></i> Rendez-vous
        </a>
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>prescription/prescription_list.php"
        ...
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>vente/vente_list.php"
           class="nav-item <?php echo $current_dir=='vente' ? 'active' : ''; ?>">
            <i class="bi bi-cart3"></i> Ventes
        </a>
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>paiement/paiement_list.php"
        ...
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>monture/monture_list.php"
           class="nav-item <?php echo $current_dir=='monture' ? 'active' : ''; ?>">
            <i class="bi bi-eyeglasses"></i> Montures
        </a>
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>verre/verre_list.php"
           class="nav-item <?php echo $current_dir=='verre' ? 'active' : ''; ?>">
            <i class="bi bi-circle-half"></i> Verres
        </a>
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>lentille/lentille_list.php"
        ...
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>fournisseur/fournisseur_list.php"
           class="nav-item <?php echo $current_dir=='fournisseur' ? 'active' : ''; ?>">
            <i class="bi bi-truck"></i> Fournisseurs
        </a>
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>commande/commande_list.php"
           class="nav-item <?php echo $current_dir=='commande' ? 'active' : ''; ?>">
            <i class="bi bi-box-seam"></i> Commandes
        </a>

        <div class="nav-section-title">Administration</div>
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>utilisateur/utilisateur_list.php"
           class="nav-item <?php echo $current_dir=='utilisateur' ? 'active' : ''; ?>">
            <i class="bi bi-person-gear"></i> Utilisateurs
        </a>
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>categorie/categorie_list.php"
           class="nav-item <?php echo $current_dir=='categorie' ? 'active' : ''; ?>">
            <i class="bi bi-tags"></i> Catégories
        </a>
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>marque/marque_list.php"
    ...
    <div class="sidebar-user">
        ...
        <a href="<?php echo str_repeat('../', substr_count(str_replace('\\','/',$_SERVER['PHP_SELF']),'/')-1); ?>logout.php" style="color:#475569; font-size:16px;">
...
<div id="topbar">
    ...
    <div style="display:flex; gap:8px; align-items:center;">
        <?php if(isset($btn_action)): ?>
            <a href="<?php echo $btn_action_url; ?>" class="btn-topbar primary">
