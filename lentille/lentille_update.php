...
$stmt = mysqli_prepare($con,
    "UPDATE lentille SET nom=?, idmarque=?, type=?, materiau=?, correction=?, couleur=?,
     diametre=?, rayon_courbure=?, puissance_min=?, puissance_max=?,
     prix=?, stock=?, idfournisseur=?, description=?
     WHERE idlentille=?");
mysqli_stmt_bind_param($stmt, "ssssssddddiiss",
    $nom, $idmarque, $type, $materiau, $correction, $couleur,
    $diametre, $rayon_courbure, $puissance_min, $puissance_max,
    $prix, $stock, $idfournisseur, $description, $idlentille);
