...
$stmt = mysqli_prepare($con,
    "UPDATE verre SET nom=?, type=?, indice=?, traitement=?, prix=?, idmarque=?, description=?
     WHERE idverre=?");
mysqli_stmt_bind_param($stmt, "ssdssss s",
    $nom, $type, $indice, $traitement, $prix, $idmarque, $description, $idverre);
